...
GITHUB_RAW="https://raw.githubusercontent.com/caothemanh/mtunnel-license-server/main"
...
echo ""
echo -e "  ${CYAN}Cap nhat LicenseChecker.java trong app:${NC}"
echo -e "  ${BOLD}VERIFY_URL = \"https://$DOMAIN/api/verify\"${NC}"
echo ""
